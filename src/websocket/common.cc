...
future<> connection<is_client>::handle_ping(temporary_buffer<char> buff) {
    return send_data(opcodes::PONG, std::move(buff));
}

template <bool is_client>
future<> connection<is_client>::handle_pong() {
    // TODO
...
template <bool is_client>
future<> connection<is_client>::send_data(opcodes opcode, temporary_buffer<char> buff) {
...
template <bool is_client>
future<> connection<is_client>::response_loop() {
...
template <bool is_client>
void connection<is_client>::shutdown_input() {
    _fd.shutdown_input();
}

template <bool is_client>
future<> connection<is_client>::close(bool send_close) {
...
template <bool is_client>
future<> connection<is_client>::read_one() {
...
template class connection<true>;
template class connection<false>;
